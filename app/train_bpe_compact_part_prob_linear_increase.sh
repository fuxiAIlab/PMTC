...
part_prob_min=${14:-0.0}
part_prob_max=${15:-0.5}
debugN=${16:-0}
...
# DEBUG
# -------------------------------------------------------------------
# bash train_bpe_compact_part_prob_linear_increase.sh 512 3 2 5 1 bert 512 0 4 mlm 0.15 0.5 0.01 0.0 0.5 50
# small DEBUG
# bash train_bpe_compact_part_prob_linear_increase.sh 512 3 2 5 1 bert 512 0 8 mlm 0.15 0.5 0.01 0.0 0.5 500
# -------------------------------------------------------------------
...
# bash train_bpe_compact_part_prob_linear_increase.sh 512 3 8 20 1 bert 40000 0 32 mlm 0.15 0.5 0.01 0.0 0.5 200000
# -------------------------------------------------------------------
...
is_timestamp_rnn=0
clm_sample_n=1
mask_type=part_prob_linear_increase # posterior_prob, tf_idf, posterior_prob_with_tf_idf_warmup, lowest_prob
...
python3.6 -m torch.distributed.launch --nproc_per_node=$ngpu train_compact_bpe.py \
  ...
  --part_prob_min $part_prob_min \
  --part_prob_max $part_prob_max \
