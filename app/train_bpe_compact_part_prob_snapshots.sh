...
# DEBUG
# -------------------------------------------------------------------
# bash train_bpe_compact_part_prob_snapshots.sh 512 3 2 5 1 bert 512 0 4 mlm 0.15 0.5 0.1 0.2 20 200
# -------------------------------------------------------------------
...
python3.6 -m torch.distributed.launch --nproc_per_node=$ngpu train_compact_bpe.py \
  ...
  --is_record_snapshot $is_record_snapshot \
