...
# small DEBUG
# bash train_bpe_compact_part_prob_auto_t_linear_increase.sh 512 3 2 5 1 bert 512 0 8 mlm 0.16 0.5 0.0 500
# -------------------------------------------------------------------

# -------------------------------------------------------------------
# 一天内能跑完的版本
# -------------------------------------------------------------------
# bash train_bpe_compact_part_prob_auto_t_linear_increase.sh 512 7 8 20 1 bert 40000 0 32 mlm 0.16 0.5 0.0 200000
# -------------------------------------------------------------------
