...
# DEBUG
# -------------------------------------------------------------------
# bash train_bpe_compact_softmaxt_exp_concave_decay.sh 512 3 2 5 1 bert 512 0 4 mlm 0.15 0.5 0.00001 50
# small DEBUG
# bash train_bpe_compact_softmaxt_exp_concave_decay.sh 512 3 2 5 1 bert 512 0 8 mlm 0.15 0.5 0.00001 200
# -------------------------------------------------------------------
...
# -------------------------------------------------------------------
# 128GB内存版本：
# bash train_bpe_compact_softmaxt_exp_concave_decay.sh 512 3 8 20 1 bert 80000 0 32 mlm 0.15 0.5 0.1 0
# 64GB内存版本 (latest: 85704)
# bash train_bpe_compact_softmaxt_exp_concave_decay.sh 512 3 8 20 1 bert 40000 0 32 mlm 0.15 0.5 0.1 0
# -------------------------------------------------------------------

# -------------------------------------------------------------------
# 一天内能跑完的版本
# -------------------------------------------------------------------
# bash train_bpe_compact_softmaxt_exp_concave_decay.sh 512 3 8 20 1 bert 40000 0 32 mlm 0.15 0.5 0.1 200000
# -------------------------------------------------------------------
...
softmax_t_decay_mode=exponential_concave
learning_rate=5e-4
